...
\usepackage{float}
\usepackage{amsmath,amssymb}    %The amsmath package is included for \xrightarrow
\usepackage{mathrsfs}  
\usepackage{xcolor}              % \alert vermelho bacana!               
\usepackage{esvect}   
\usepackage{cancel}
\usepackage{tikz}
\usepackage[document]{ragged2e}
%%% Pacotes para criar caixas e altera-las:
...
\definecolor{MyDarkRed}{rgb}{0.502,0,0}
\definecolor{MyDarkBlue}{rgb}{0,0,0.252}
\definecolor{MyDarkViolet}{rgb}{0.602,0,0.602}
\definecolor{MyDarkGreen}{rgb}{0,0.602,0}
\definecolor{MyDarkYellow}{cmyk}{0,0,1,0.3}

\definecolor{MyClearBlue}{rgb}{0.2,0.8,0.702}
...
\newcommand{\pink}[1]{{\color{MyDarkViolet} #1}}
...
\newcommand{\piw}{\skew{4.5}\hat{P}_i}
...
\newtcolorbox{tcbdoublebox}[1][]{enhanced  jigsaw, sharp corners, colback=Brown, borderline={1pt}{-2pt}{MyDarkRed},%
	      fontupper={\setlength{\parindent}{20pt}},#1}
