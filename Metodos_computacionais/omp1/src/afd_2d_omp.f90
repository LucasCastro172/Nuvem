...
real(dp),allocatable,target:: pfield1(:,:)            ! campo de onda 1
real(dp),allocatable,target:: pfield2(:,:)            ! campo de onda 2
real(dp),pointer:: p1(:,:)            ! campo de onda instante 1
real(dp),pointer:: p2(:,:)            ! campo de onda instante 2
real(dp),pointer:: pswap(:,:)          ! auxiliar pointer
!
! 
...
!$omp shared(nzz,nxx,nz,p1,p2,vel,pswap,gama_x,gama_z,fonte,srcmask,nthreads)    &
...
close(SUMVID)
!
print *,"fd_time = ",fd_update_time/real(nthreads)
print *,"swap_time = ",swp_time/real(nthreads)
!
