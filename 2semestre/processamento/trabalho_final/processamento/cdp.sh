...
# Esse $1 indica que vai entrar o valor que vc colocar qndo mandar rodar o programa.
#sh showshot.sh 5 - por exemplo.
...
suchw<camadas_planas.su key1=cdp key2=gx key3=sx b=1 c=1 d=2 > temp1
