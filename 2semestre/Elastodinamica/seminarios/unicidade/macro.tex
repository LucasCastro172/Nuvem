...
\newcommand{\vwf}{\skew{4.5}\hat{V}_i}
...
\newcommand{\Pij}[2]{P_{i#1,j#2}}
\newcommand{\Vxij}[2]{V\!x_{i#1,j#2}}
\newcommand{\Vzij}[2]{V\!z_{i#1,j#2}}
\newcommand{\Vxijl}[3][]{V\!x_{i#1,j#2}^{l#3}}
\newcommand{\Vzijl}[3][]{V\!z_{i#1,j#2}^{l#3}}
